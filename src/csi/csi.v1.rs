        ...
        impl Type {
            ...
            pub fn as_str_name(&self) -> &'static str {
                match self {
                    ...
                    Self::GroupControllerService => "GROUP_CONTROLLER_SERVICE",
                    Self::SnapshotMetadataService => "SNAPSHOT_METADATA_SERVICE",
                }
            }
            ...
            pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
                match value {
                    ...
                    "SNAPSHOT_METADATA_SERVICE" => Some(Self::SnapshotMetadataService),
                    _ => None,
                }
            }
        }
        ...
        impl Mode {
            ...
            pub fn as_str_name(&self) -> &'static str {
                match self {
                    ...
                    Self::SingleNodeSingleWriter => "SINGLE_NODE_SINGLE_WRITER",
                    Self::SingleNodeMultiWriter => "SINGLE_NODE_MULTI_WRITER",
                }
            }
            /// Creates an enum from field names used in the ProtoBuf definition.
            pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        ...
        impl Type {
            ...
            pub fn as_str_name(&self) -> &'static str {
                match self {
                    ...
                    Self::SingleNodeMultiWriter => "SINGLE_NODE_MULTI_WRITER",
                    Self::ModifyVolume => "MODIFY_VOLUME",
                }
            }
            /// Creates an enum from field names used in the ProtoBuf definition.
            pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        ...
        impl Type {
            ...
            pub fn as_str_name(&self) -> &'static str {
                match self {
                    ...
                    Self::VolumeCondition => "VOLUME_CONDITION",
                    Self::SingleNodeMultiWriter => "SINGLE_NODE_MULTI_WRITER",
                    Self::VolumeMountGroup => "VOLUME_MOUNT_GROUP",
                }
            }
            /// Creates an enum from field names used in the ProtoBuf definition.
            pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
    ...
    pub mod rpc {
        ...
        impl Type {
            ...
            pub fn as_str_name(&self) -> &'static str {
                match self {
                    Self::Unknown => "UNKNOWN",
                    Self::CreateDeleteGetVolumeGroupSnapshot => {
...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct GetMetadataAllocatedRequest {
...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct GetMetadataAllocatedResponse {
    ...
    /// This field is REQUIRED.
    #[prost(enumeration = "BlockMetadataType", tag = "1")]
    ...
    /// This field is OPTIONAL.
    #[prost(message, repeated, tag = "3")]
    pub block_metadata: ::prost::alloc::vec::Vec<BlockMetadata>,
}
...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct GetMetadataDeltaRequest {
...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct GetMetadataDeltaResponse {
    /// This specifies the style used in the BlockMetadata sequence.
    /// This value must be the same in all such messages returned by
    /// the stream.
    /// If block_metadata_type is FIXED_LENGTH, then the size_bytes field
...
impl BlockMetadataType {
    ...
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            "UNKNOWN" => Some(Self::Unknown),
            "FIXED_LENGTH" => Some(Self::FixedLength),
            "VARIABLE_LENGTH" => Some(Self::VariableLength),
            _ => None,
        }
    }
}
...
pub mod group_controller_client {
    ...
    impl GroupControllerClient<tonic::transport::Channel> {
        /// Attempt to create a new client by connecting to a given endpoint.
        pub async fn connect<D>(dst: D) -> Result<Self, tonic::transport::Error>
        where
            D: TryInto<tonic::transport::Endpoint>,
...
/// Generated client implementations.
pub mod snapshot_metadata_client {
    #![allow(
        unused_variables,
        dead_code,
        missing_docs,
    ...
    use tonic::codegen::http::Uri;
    #[derive(Debug, Clone)]
    pub struct SnapshotMetadataClient<T> {
        inner: tonic::client::Grpc<T>,
    }
    impl SnapshotMetadataClient<tonic::transport::Channel> {
        /// Attempt to create a new client by connecting to a given endpoint.
        pub async fn connect<D>(dst: D) -> Result<Self, tonic::transport::Error>
        where
            D: TryInto<tonic::transport::Endpoint>,
    ...
    impl<T> SnapshotMetadataClient<T>
    where
        T: tonic::client::GrpcService<tonic::body::BoxBody>,
        T::Error: Into<StdError>,
        T::ResponseBody: Body<Data = Bytes> + std::marker::Send + 'static,
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub fn with_interceptor<F>(
            inner: T,
            interceptor: F,
        ) -> SnapshotMetadataClient<InterceptedService<T, F>>
        where
            F: tonic::service::Interceptor,
            T::ResponseBody: Default,
            T: tonic::codegen::Service<
            ...
            >>::Error: Into<StdError> + std::marker::Send + std::marker::Sync,
        {
            SnapshotMetadataClient::new(InterceptedService::new(inner, interceptor))
        }
        /// Compress requests with the given encoding.
        ///
        /// This requires the server to support it otherwise it might respond with an
        ...
        pub async fn get_metadata_allocated(
            &mut self,
            request: impl tonic::IntoRequest<super::GetMetadataAllocatedRequest>,
        ) -> std::result::Result<
            tonic::Response<
                tonic::codec::Streaming<super::GetMetadataAllocatedResponse>,
            >,
            tonic::Status,
        > {
            self.inner
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("csi.v1.SnapshotMetadata", "GetMetadataAllocated"),
                );
            self.inner.server_streaming(req, path, codec).await
        }
        pub async fn get_metadata_delta(
            &mut self,
            request: impl tonic::IntoRequest<super::GetMetadataDeltaRequest>,
        ) -> std::result::Result<
            tonic::Response<tonic::codec::Streaming<super::GetMetadataDeltaResponse>>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("csi.v1.SnapshotMetadata", "GetMetadataDelta"));
            self.inner.server_streaming(req, path, codec).await
        }
    }
}
...
pub mod group_controller_server {
    ...
    #[async_trait]
    pub trait GroupController: std::marker::Send + std::marker::Sync + 'static {
    ...
    #[derive(Debug)]
    pub struct GroupControllerServer<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T> GroupControllerServer<T> {
        pub fn new(inner: T) -> Self {
            Self::from_arc(Arc::new(inner))
        }
        pub fn from_arc(inner: Arc<T>) -> Self {
    ...
    impl<T> Clone for GroupControllerServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "csi.v1.GroupController";
    impl<T> tonic::server::NamedService for GroupControllerServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
/// Generated server implementations.
pub mod snapshot_metadata_server {
    #![allow(
        unused_variables,
        dead_code,
        missing_docs,
    ...
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with SnapshotMetadataServer.
    #[async_trait]
    pub trait SnapshotMetadata: std::marker::Send + std::marker::Sync + 'static {
        /// Server streaming response type for the GetMetadataAllocated method.
        type GetMetadataAllocatedStream: tonic::codegen::tokio_stream::Stream<
                Item = std::result::Result<
                    super::GetMetadataAllocatedResponse,
                    tonic::Status,
                >,
            >
            + std::marker::Send
        ...
        async fn get_metadata_allocated(
            &self,
            request: tonic::Request<super::GetMetadataAllocatedRequest>,
        ) -> std::result::Result<
            tonic::Response<Self::GetMetadataAllocatedStream>,
            tonic::Status,
        >;
        /// Server streaming response type for the GetMetadataDelta method.
        type GetMetadataDeltaStream: tonic::codegen::tokio_stream::Stream<
                Item = std::result::Result<
                    super::GetMetadataDeltaResponse,
                    tonic::Status,
                >,
            >
            + std::marker::Send
        ...
        async fn get_metadata_delta(
            &self,
            request: tonic::Request<super::GetMetadataDeltaRequest>,
        ) -> std::result::Result<
            tonic::Response<Self::GetMetadataDeltaStream>,
            tonic::Status,
        >;
    }
    #[derive(Debug)]
    pub struct SnapshotMetadataServer<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T> SnapshotMetadataServer<T> {
        pub fn new(inner: T) -> Self {
            Self::from_arc(Arc::new(inner))
        }
        pub fn from_arc(inner: Arc<T>) -> Self {
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for SnapshotMetadataServer<T>
    where
        T: SnapshotMetadata,
        B: Body + std::marker::Send + 'static,
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/csi.v1.SnapshotMetadata/GetMetadataAllocated" => {
                    #[allow(non_camel_case_types)]
                    struct GetMetadataAllocatedSvc<T: SnapshotMetadata>(pub Arc<T>);
                    impl<
                        T: SnapshotMetadata,
                    > tonic::server::ServerStreamingService<
                        super::GetMetadataAllocatedRequest,
                    > for GetMetadataAllocatedSvc<T> {
                        type Response = super::GetMetadataAllocatedResponse;
                        type ResponseStream = T::GetMetadataAllocatedStream;
                        type Future = BoxFuture<
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as SnapshotMetadata>::get_metadata_allocated(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = GetMetadataAllocatedSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/csi.v1.SnapshotMetadata/GetMetadataDelta" => {
                    #[allow(non_camel_case_types)]
                    struct GetMetadataDeltaSvc<T: SnapshotMetadata>(pub Arc<T>);
                    impl<
                        T: SnapshotMetadata,
                    > tonic::server::ServerStreamingService<
                        super::GetMetadataDeltaRequest,
                    > for GetMetadataDeltaSvc<T> {
                        type Response = super::GetMetadataDeltaResponse;
                        type ResponseStream = T::GetMetadataDeltaStream;
                        type Future = BoxFuture<
                            tonic::Response<Self::ResponseStream>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as SnapshotMetadata>::get_metadata_delta(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = GetMetadataDeltaSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    impl<T> Clone for SnapshotMetadataServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "csi.v1.SnapshotMetadata";
    impl<T> tonic::server::NamedService for SnapshotMetadataServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
/// Generated server implementations.
